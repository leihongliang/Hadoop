...
public class HdfsClient {
    ...
    public void testPut() throws IOException {
        ...
        fs.copyFromLocalFile(false, true, new Path("E:\\HDU\\Java\\Learn\\Hadoop\\hadoop01-hdfs\\test.txt"),
                new Path("hdfs://namenode/hdfs-test/test1"));
    ...
    public void testGet() throws IOException {
        ...
        fs.copyToLocalFile(false, new Path("hdfs://namenode/hdfs-test/test1"),
                new Path(" \\test2.txt"), false);
    }
